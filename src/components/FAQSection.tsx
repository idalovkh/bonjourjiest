...
const faqs = [
  ...
  },
  {
    ...
    a: "У наших преподавателей есть международные сертификаты и дипломы, подтверждающие высокий уровень владения языком. Главное — мы учим говорить, а не делать упражнения.",
  },
  {
  ...
  },
  {
    ...
    a: "Да, у нас большой опыт подготовки к экзаменам. Наши студенты сдают DELF, DALF, TCF, TEF и другие экзамены на высокие баллы и поступают в международные ВУЗы.",
  },
  {
