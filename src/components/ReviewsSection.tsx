...
const reviews = [
  {
    name: "Магомед",
    text: "Начинал с нуля — за полгода уже уверенно разговариваю на бытовые темы. Уроки живые, много практики, а не зубрёжка правил.",
  },
  {
    name: "Екатерина",
    text: "Готовилась к DELF B1 и сдала с первого раза. Преподаватель чётко разобрал формат экзамена и слабые места — без лишней воды.",
  },
  {
    name: "Тамара",
    text: "Учусь онлайн после работы — удобно подстраивать расписание. За три месяца перестала бояться говорить и начала понимать фильмы без субтитров.",
  },
  {
    name: "Камилла",
    text: "Занимаемся в паре с подругой — атмосфера лёгкая, но прогресс реальный. Французский перестал казаться чем-то недостижимым.",
  },
  {
    name: "Марьям",
    text: "Пробный урок помог понять, что школа мне подходит. Сейчас на уроках много разговорной практики — именно этого не хватало раньше.",
  },
  {
    name: "Диана",
    text: "Отдала дочь на занятия — она с нетерпением ждёт каждый урок. Преподаватель находит общий язык с ребёнком и держит интерес.",
  },
];
